import {
  ...
  export function getCountryFlag(title, countryCode) {
    ...
    countrySpan.style.backgroundImage = "url(/static/images/flags/" + countryCode.toLowerCase() + ".svg";
    return countrySpan;
  }
  ...
  export function getSubdivisionFlag(title, countryCode, subdivisionCode) {
    ...
    stateSpan.style.backgroundImage = "url(/static/images/flags/" + countryCode.toLowerCase() + "/" + subdivisionCode.toLowerCase() + ".svg";
    return stateSpan;
  }
